...
public class VehicleClassificationEntity {
    ...
    public VehicleClassificationEntity() {
    }

    public VehicleClassificationEntity(Long id, String vehicleType, String confidence, String camera, String detectedTime, String imagePath) {
        this.id = id;
